...
public class UACAudioHandler extends Handler {
    ...
    public static UACAudioHandler createHandler() {
        AudioThread audioThread = new AudioThread(UACAudioHandler.class);
        audioThread.start();
...
//        private final USBMonitor.UsbControlBlock mCtrlBlock;
        ...
        public AudioThread(Class<UACAudioHandler> handlerClass) {
